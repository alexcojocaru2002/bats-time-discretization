...
def plot(dt_list,  base_folder='output_metrics/continuous_vs_discrete/'):
    ...
    first_legend = plt.legend(handles=dt_handles, fontsize=15,
                               bbox_to_anchor=(1.25, 0.9), loc='upper left', borderaxespad=0.)
    ...
    save_path = os.path.join(base_folder, 'continuous_vs_discrete_mnist.pdf')
...
DT_LIST = [0.0004, 0.001, 0.002, 0.003, 0.004, 0.005]
