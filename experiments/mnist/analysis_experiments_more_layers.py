...
network_configs=[[800], [800, 800], [800, 800, 800], [800, 800, 800, 800], [800, 800, 800, 800, 800], [800, 800, 800, 800, 800, 800], [800, 800, 800, 800, 800, 800, 800]] # Problem, make sure the biggest network is last!
...
for layer in network.layers:
    mse[layer.name] = np.zeros((len(network_configs), ))
for layer in network.layers:
