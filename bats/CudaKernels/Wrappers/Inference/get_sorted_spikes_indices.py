...
def get_sorted_spikes_indices(spike_times_per_neuron, n_spike_per_neuron, spike_times_per_neuron_discrete):
    ...
    discrete_spike_times_reshaped = cp.reshape(spike_times_per_neuron_discrete, new_shape)
    ...
    discrete_sorted_indices = cp.argpartition(discrete_spike_times_reshaped, n, axis=1)[:, :max_total_spike]
    return new_shape, sorted_indices, spike_times_reshaped, discrete_sorted_indices, discrete_spike_times_reshaped
